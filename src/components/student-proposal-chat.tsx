  ...
  useEffect(() => {
    if (session?.user) {
      const welcomeMessage: ChatMessage = {
        ...
        type: 'ai',
        content: `Hi ${session.user.name?.split(' ')[0]}! 👋 

I'm your career assistant. I can help you find opportunities and send proposals to companies. What would you like to explore today?`,
        timestamp: new Date(),
        actionType: 'guidance'
      }
  ...
  const loadStudentData = async () => {
    try {
      ...
      // Mock data for live projects and companies
      setLiveProjects([
        {
          id: '1',
      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          >
            ...
            <p className="text-xs text-orange-600">New this week</p>
          </motion.div>
        </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1 relative">
                    <input
                      ...
                      placeholder="Ask about opportunities, companies, or send proposals..."
