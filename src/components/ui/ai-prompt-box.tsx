...
import { ArrowUp, Paperclip, Square, X, StopCircle, Mic, Globe, BrainCog, FolderCode, Plus, Search } from "lucide-react";
        ...
        <Button
          ...
          className={cn(
            ...
            mode === 'create-project' 
              ...
              : "bg-transparent border-[#444444] text-gray-300 hover:bg-[#3A3A40] hover:text-white"
          )}
