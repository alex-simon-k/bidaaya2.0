    ...
    <div className={`w-full max-w-md mx-auto ${className}`}>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3 px-2">
          ...
          <button onClick={() => onEditSection('skills')} className="text-xs text-emerald-500 hover:text-emerald-400 font-medium">Edit</button>
        </div>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3 px-2">
          ...
          <button onClick={() => onEditSection('experience')} className="text-xs text-emerald-500 hover:text-emerald-400 font-medium">Edit</button>
        </div>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3 px-2">
          ...
          <button onClick={() => onEditSection('education')} className="text-xs text-emerald-500 hover:text-emerald-400 font-medium">Edit</button>
        </div>
        <div className="space-y-3">
      ...
      <div className="mb-24">
        <div className="flex items-center justify-between mb-3 px-2">
          ...
          <button onClick={() => onEditSection('projects')} className="text-xs text-emerald-500 hover:text-emerald-400 font-medium">Edit</button>
        </div>
                 ...
                 <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {proj.skills.map((skill, idx) => (
                        <span key={idx} className="text-xs text-emerald-400/80">#{skill}</span>
                      ))}
                    </div>
                 </div>
