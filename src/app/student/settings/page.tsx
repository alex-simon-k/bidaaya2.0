...
export default function StudentSettings() {
  ...
  return (
    <StudentLayoutWrapper>
      <div className="min-h-screen bg-bidaaya-dark py-8 px-4 sm:px-6 lg:px-8 pb-24">
        <div className="max-w-4xl mx-auto space-y-6">
          {/* Header */}
          <div className="flex items-center gap-4 mb-6">
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-bidaaya-light">Settings & Credits</h1>
              <p className="mt-2 text-bidaaya-light/70">
          ...
          <motion.div
            ...
            className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] rounded-lg p-6"
          >
            <h2 className="text-xl font-semibold text-bidaaya-light mb-4 flex items-center">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-3 border-b border-white/10">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-bidaaya-light">Early Access Unlock</p>
                    <p className="text-sm text-bidaaya-light/60">Unlock any opportunity 24hrs before public release</p>
                  </div>
                </div>
                <span className="text-xl font-bold text-purple-400">{CREDIT_COSTS.EARLY_ACCESS}</span>
              </div>
              ...
              <div className="flex items-center justify-between py-3 border-b border-white/10">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-bidaaya-light">Custom CV Generation</p>
                    <p className="text-sm text-bidaaya-light/60">AI-powered CV tailored to each opportunity</p>
                  </div>
                </div>
                <span className="text-xl font-bold text-blue-400">{CREDIT_COSTS.CUSTOM_CV}</span>
              </div>
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-bidaaya-light">Custom Cover Letter</p>
                    <p className="text-sm text-bidaaya-light/60">Personalized cover letter for applications</p>
                  </div>
                </div>
                <span className="text-xl font-bold text-green-400">{CREDIT_COSTS.CUSTOM_COVER_LETTER}</span>
              </div>
            </div>
            ...
            {creditInfo?.subscriptionPlan !== 'STUDENT_PRO' && (
              <div className="mt-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg p-4">
                <div className="flex items-start">
                  <Sparkles className="h-5 w-5 text-purple-400 mt-0.5 mr-3 flex-shrink-0" />
                  <div className="flex-1">
                    <p className="font-medium text-purple-300">Unlock Unlimited Early Access</p>
                    ...
                    <Link 
                      ...
                      className="inline-flex items-center mt-3 text-sm font-medium text-purple-400 hover:text-purple-300"
                    >
                      Upgrade to Pro
          ...
          {/* Subscription Management - Dark Theme Version */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] rounded-lg p-6"
          >
            <h2 className="text-xl font-semibold text-bidaaya-light mb-6">Subscription Management</h2>
