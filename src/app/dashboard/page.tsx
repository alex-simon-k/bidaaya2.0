  ...
  if (userRole === 'STUDENT') {
    return (
      <div className="min-h-screen bg-gray-50">
        {/* Quick Stats Header for Students */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-purple-600 font-medium">Proposals Sent</p>
                    <p className="text-2xl font-bold text-purple-900">{stats.proposals || 0}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-green-600 font-medium">Profile Views</p>
              ...
              <div className="bg-orange-50 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-orange-600 font-medium">Opportunities</p>
                    <p className="text-2xl font-bold text-orange-900">{stats.projects}</p>
                  </div>
                </div>
              </div>
            </div>
